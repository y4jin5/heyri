...
document.getElementById("defaultOpen").click();
    ...
    jQuery(window).on("scroll",function(ev){
        ...
        }else if(jQuery(window).scrollTop() >= jQuery('.section2').scrollTop()){
            jQuery('.slideLeft').addClass('ani');
            jQuery('.fade').addClass('ani2');
        }else if(jQuery(window).scrollTop() >= jQuery('.section3').scrollTop() ) { 
        }else if(jQuery(window).scrollTop() >= jQuery('.section4').scrollTop() ) { 
    ...
    // if (jQuery(window).width() > 0) {
    // jQuery(window).on("scroll",function(ev){
    //     if(jQuery(window).scrollTop() > jQuery('.section2').scrollTop() ) { /**높이 픽셀 조정**/
    //         jQuery('.slideLeft').addClass('ani');
    ...
    // if (jQuery(window).width() > 0) {
    // jQuery(window).on("scroll",function(ev){
    //     if(jQuery(window).scrollTop() > jQuery('.section3').scrollTop() ) { /**높이 픽셀 조정**/
    ...
    // if (jQuery(window).width() > 0) {
    // jQuery(window).on("scroll",function(ev){
    //     if(jQuery(window).scrollTop() > jQuery('.section4').scrollTop() ) { /**높이 픽셀 조정**/
    ...
    // if (jQuery(window).width() > 0) {
    // jQuery(window).on("scroll",function(ev){
    //     if(jQuery(window).scrollTop() > jQuery('.section5').scrollTop() ) { /**높이 픽셀 조정**/
